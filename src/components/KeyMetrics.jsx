  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h2 className="text-3xl mb-6 flex items-center gap-2 text-gray-800">
        <BarChart className="w-8 h-8 text-blue-600 kanit-extrabold" /> Key
        Metrics
      </h2>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 oxygen-light">
      ...
      <div className="bg-white shadow-lg rounded-lg p-4 border border-gray-300 mt-6">
        <h3 className="text-xl oxygen-bold mb-3">File Details</h3>
      ...
      {smallFiles.length > 0 && (
        <div className="bg-red-50 shadow-lg rounded-lg p-4 border border-red-300 mt-6">
          <h3 className="text-xl oxygen-light text-red-700 mb-3 flex items-center gap-2">
